...
public class ECN_DC extends javax.swing.JFrame {
    ...
    public ECN_DC() {
        ...
        jTextArea1.setBackground(new java.awt.Color(31, 31, 35));
    ...
    private void initComponents() {
        ...
        cmb_customer.setBackground(new java.awt.Color(31, 31, 35));
        cmb_customer.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        cmb_customer.setForeground(new java.awt.Color(242, 242, 242));
        cmb_customer.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Customer A", "Customer B", "Customer C", "Customer D" }));
        cmb_customer.setFocusable(false);
        ...
        jTextArea1.setForeground(new java.awt.Color(47, 50, 52));
        jTextArea1.setRows(5);
        jTextArea1.setCaretColor(new java.awt.Color(47, 50, 52));
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanelBodyLayout.createSequentialGroup()
                            .addGroup(jPanelBodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addGroup(jPanelBodyLayout.createSequentialGroup()
                                    ...
                                    .addGap(14, 14, 14)
                                    .addComponent(cmb_customer, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE))
                            ...
                            .addGroup(jPanelBodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanelBodyLayout.createSequentialGroup()
                                    .addGap(58, 58, 58)
                                    .addGroup(jPanelBodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(btn_upload, javax.swing.GroupLayout.PREFERRED_SIZE, 331, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGroup(jPanelBodyLayout.createSequentialGroup()
        ...
        jPanelBodyLayout.setVerticalGroup(
            ...
            .addGroup(jPanelBodyLayout.createSequentialGroup()
                ...
                .addGroup(jPanelBodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cmb_customer, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btn_submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_submitActionPerformed
       ...
       if(JDate_req.getDate() == null) {
            ...
            int row_count1= stcon1.insertUpdateDeleteData("INSERT INTO ecn (ecn_year, ecn_number,requested_date,implemented_date) VALUES ('"+year+"','"+ecn_num+"','"+requested_date+"','"+implemented_date+"')");
    ...
    /*for (int i=0;i<prod-1;i++){
                final JTextField textField = textboxes[i];
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ECN_DC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
