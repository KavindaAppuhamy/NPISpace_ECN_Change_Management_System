...
public class ECN_DC_Dashboard extends javax.swing.JFrame {
    private String name,id,deptID;

    public ECN_DC_Dashboard() {
        initComponents();
        setIcon();
        setTitle("NPI SPACE");
    ...
    private void initComponents() {
        ...
        btn_ex_ecn = new javax.swing.JButton();
        ...
        btn_ex_ecn.setBackground(new java.awt.Color(31, 31, 35));
        btn_ex_ecn.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        btn_ex_ecn.setForeground(new java.awt.Color(242, 242, 242));
        btn_ex_ecn.setText("EXTERNAL ECN");
        btn_ex_ecn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_ex_ecnActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btn_ex_ecn, javax.swing.GroupLayout.PREFERRED_SIZE, 438, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btn_ex_ecn, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btn_logoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_logoutActionPerformed
            ...
            ECN_DC_Dashboard.this.setVisible(false);
            user_login.setVisible(true);
    }//GEN-LAST:event_btn_logoutActionPerformed

    private void btn_ex_ecnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ex_ecnActionPerformed
                ECN_External_Dashboard ecn=new ECN_External_Dashboard();
                ecn.setID(id);
                ecn.setName(name);
                ecn.setDeptID(deptID);
                ECN_DC_Dashboard.this.setVisible(false);
                ecn.setVisible(true);           
    }//GEN-LAST:event_btn_ex_ecnActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ECN_DC_Dashboard().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btn_ex_ecn;
