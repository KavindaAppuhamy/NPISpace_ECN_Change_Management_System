...
public class Admin_Dashboard_Customer extends javax.swing.JFrame {
    private String name,id,deptID;
    String dfVerified="No";

    public Admin_Dashboard_Customer() {
        initComponents();
        setIcon();
        setTitle("NPI SPACE");
    ...
    private void initComponents() {
        ...
        lbl_dashboard.setText("MANAGE CUSTOMERS");
        ...
        HANDOVERS.setText("EDIT CUSTOMERS");
        ...
        HANDOVERS1.setText("REMOVE CUSTOMERS");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGap(32, 32, 32)
                .addComponent(lbl_dashboard, javax.swing.GroupLayout.PREFERRED_SIZE, 418, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btn_logoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_logoutActionPerformed
            ...
            Admin_Dashboard_Customer.this.setVisible(false);
    ...
    private void HANDOVERSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HANDOVERSActionPerformed
                Admin_Customers_Update ecn=new Admin_Customers_Update();
                ecn.setID(id);
                ecn.setName(name);
    ...
    private void ECNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ECNActionPerformed
                ...
                Admin_Customers_Add ecn=new Admin_Customers_Add();
                ecn.setID(id);
                ecn.setName(name);
                ecn.setDeptID(deptID);
                //ecn.setPendingECN();
    ...
    private void HANDOVERS1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HANDOVERS1ActionPerformed
                Admin_Customers_Delete ecn=new Admin_Customers_Delete();
                ecn.setID(id);
                ecn.setName(name);
                ecn.setDeptID(deptID);
                //ecn.setPendingECN();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Dashboard_Customer().setVisible(true);
            }
        });
    }
