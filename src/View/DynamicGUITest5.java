...
public class DynamicGUITest5 extends javax.swing.JFrame {
    private String name, id;
    JPanel contentPane = new JPanel();
    String myProducts[];
    private boolean clicked = false;
    
    public DynamicGUITest5() {
        ...
        jScrollPaneBody.setViewport(viewport);     
              ...
              for( Component c : jXDatePicker2.getComponents()){
    ...
    private void initComponents() {
        ...
        jXDatePicker2.setBackground(new java.awt.Color(0, 51, 255));
        ...
        jPanelBodyLayout.setVerticalGroup(
            ...
            .addGroup(jPanelBodyLayout.createSequentialGroup()
                ...
                .addGroup(jPanelBodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelBodyLayout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jScrollPaneBody, javax.swing.GroupLayout.DEFAULT_SIZE, 400, Short.MAX_VALUE)))
                .addGap(18, 18, 18))
        );
    ...
    private void btn_backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_backActionPerformed
        ...
        DynamicGUITest5.this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DynamicGUITest5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new DynamicGUITest5().setVisible(true);
