...
public class DynamicGUITest6 extends javax.swing.JFrame {
    private String name, id;
    JPanel contentPane = new JPanel();
    String myProducts[];
    private boolean clicked = false;
    
    public DynamicGUITest6() {
        ...
        jScrollPaneBody.setViewport(viewport);     
              ...
              for( Component c : jXDatePicker3.getComponents()){
                ((JComponent)c).setBackground(Color.DARK_GRAY);
              }
              Date date = new Date();
              jXDatePicker3.setDate(date);
              //jXDatePicker3.getComponent(2).setEnabled(false);
            ...
            .addGroup(jPanelBodyLayout.createSequentialGroup()
                ...
                .addGroup(jPanelBodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelBodyLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jScrollPaneBody, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
    ...
    private void btn_backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_backActionPerformed
        ...
        DynamicGUITest6.this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DynamicGUITest6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new DynamicGUITest6().setVisible(true);
