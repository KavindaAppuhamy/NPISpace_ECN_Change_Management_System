...
public class DynamicGUITest3 extends javax.swing.JFrame {
    ...
    private void btn_backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_backActionPerformed
        ...
        DynamicGUITest3.this.setVisible(false);
    ...
    private void btn_enterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_enterActionPerformed
       ...
       while (no_of_products>0){
            ...
            // product2.setBounds(50,150, 200,30);  
           /* product2.setFont(new java.awt.Font("Dialog", 0, 18));*/
            //product2.setBounds(33, 30, 390, 30);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DynamicGUITest3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new DynamicGUITest3().setVisible(true);
