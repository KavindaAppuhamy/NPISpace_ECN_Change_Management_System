...
public class DF_Main_Dashboard extends javax.swing.JFrame {
    private String name,id,deptID;
    String dfVerified="No";

    public DF_Main_Dashboard() {
        initComponents();
        setIcon();
        setTitle("NPI SPACE");
    ...
    private void initComponents() {
        ...
        lbl_dashboard.setText("DF DASHBOARD");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(51, 51, 51)
                .addComponent(ECN, javax.swing.GroupLayout.PREFERRED_SIZE, 440, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(HANDOVERS, javax.swing.GroupLayout.PREFERRED_SIZE, 438, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btn_logoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_logoutActionPerformed
            ...
            DF_Main_Dashboard.this.setVisible(false);
    ...
    private void HANDOVERSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HANDOVERSActionPerformed
                Handover_Dashboard_DF ecn=new Handover_Dashboard_DF();
                ecn.setID(id);
                ecn.setName(name);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DF_Main_Dashboard().setVisible(true);
            }
        });
    }
