...
public class ECN_External_Dashboard_DF extends javax.swing.JFrame {
    ...
    int ecn_num;
    String ecn_id;
    String[] columnNames = {"ECN ID", "Requested Date","Implemented Date", "Number of Products", "Customer"};

    // Create the table model
    DefaultTableModel tableModel = new DefaultTableModel(columnNames, 0);
    
    public ECN_External_Dashboard_DF() {
    ...
    public void setPendingECN(){
        try {
        StatementController stcon = new StatementController();
        //"SELECT COUNT(ecn.ecn_year) AS ecn_count FROM ecn INNER JOIN customer ON ecn.customer = customer.customer WHERE ecn.df_verified ='"+dfVerified+"' AND customer.u_id = '"+Integer.parseInt(id)+"'");
        ResultSet result = stcon.selectData("SELECT ecn.ecn_year, ecn.ecn_number, ecn.requested_date, ecn.implemented_date, ecn.no_of_products, ecn.customer AS ecn_data FROM ecn INNER JOIN customer ON ecn.customer = customer.customer WHERE ecn.df_verified ='"+dfVerified+"' AND customer.u_id = '"+Integer.parseInt(id)+"'");
        int i=0;
        ...
        jTableECN.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
                ...
                try {
                    ...
                    ResultSet result = stcon2.selectData("SELECT ecn_year, ecn_number FROM ecn WHERE df_verified='Yes'");
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                ECN_DF_Internal_Dashboard_OnClick ecn_form = new ECN_DF_Internal_Dashboard_OnClick(); // pass the data to the form constructor
                ECN_External_Dashboard_DF.this.setVisible(false);
    ...
    private void initComponents() {
        ...
        lbl_dashboard.setText("EXTERNAL ECN DASHBOARD");
        ...
        LastNameText.setText("All External ECNs");
        ...
        jTableECN.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ECN ID", "Requested Date", "Implemented Date", "Number of Products", "Customer"
            }
        ) {
    ...
    private void btn_backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_backActionPerformed
        ECN_DF_Dashboard ecn_dashboard=new ECN_DF_Dashboard();
        ECN_External_Dashboard_DF.this.setVisible(false);
        ecn_dashboard.setID(id);
        ecn_dashboard.setName(name);
        ecn_dashboard.setDeptID(deptID);
        ecn_dashboard.setNotification();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ECN_External_Dashboard_DF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new ECN_External_Dashboard_DF().setVisible(true);
