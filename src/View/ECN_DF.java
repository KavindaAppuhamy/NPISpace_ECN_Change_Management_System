...
public class ECN_DF extends javax.swing.JFrame {
    private String name, id, deptID;
    JPanel contentPane = new JPanel();
    JPanel DFPane = new JPanel();
    String myProducts[];
    ...
    public ECN_DF() {
        ...
        DFPane.setBackground(new java.awt.Color(47,50,52));
        DFPane.setLayout(new BoxLayout(DFPane, BoxLayout.Y_AXIS)); 
        JViewport viewport2 = new JViewport();
        viewport2.setView(DFPane);
        jScrollPaneBody2.setViewport(viewport2);
        
        for( Component c : jXDatePicker3.getComponents()){
    ...
    private void initComponents() {
        ...
        jScrollPaneBody2 = new javax.swing.JScrollPane();
        FirstNameText6 = new javax.swing.JLabel();
        txt_ecn_id = new javax.swing.JTextField();
        btn_select_dc_ecn = new javax.swing.JButton();
        ...
        FirstNameText1.setText("ECN Implemented Date");
        ...
        jXDatePicker3.setForeground(new java.awt.Color(255, 255, 255));

        jScrollPaneBody2.setBackground(new java.awt.Color(0, 0, 0));
        jScrollPaneBody2.setForeground(new java.awt.Color(47, 50, 52));
        jScrollPaneBody2.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
        jScrollPaneBody2.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
        jScrollPaneBody2.setAutoscrolls(true);
        jScrollPaneBody2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jScrollPaneBody2.setMaximumSize(new java.awt.Dimension(32767, 52767));

        FirstNameText6.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        FirstNameText6.setForeground(new java.awt.Color(252, 253, 242));
        FirstNameText6.setText("Enter ECN ID");
        ...
        btn_select_dc_ecn.setBackground(new java.awt.Color(14, 119, 89));
        btn_select_dc_ecn.setForeground(new java.awt.Color(255, 233, 177));
        btn_select_dc_ecn.setText("Select DC Products");
        btn_select_dc_ecn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_select_dc_ecnActionPerformed(evt);
            }
        });
        ...
        jPanelBodyLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelBodyLayout.createSequentialGroup()
                ...
                .addGroup(jPanelBodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jScrollPaneBody2, javax.swing.GroupLayout.PREFERRED_SIZE, 754, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanelBodyLayout.createSequentialGroup()
                        .addGroup(jPanelBodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelBodyLayout.createSequentialGroup()
                        ...
                        .addGap(27, 27, 27)
                        .addComponent(FirstNameText6, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txt_ecn_id, javax.swing.GroupLayout.PREFERRED_SIZE, 319, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(33, 33, 33)
                        .addComponent(btn_select_dc_ecn, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(jPanelBodyLayout.createSequentialGroup()
                ...
                .addGroup(jPanelBodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelBodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(btn_select_dc_ecn))
                ...
                .addGroup(jPanelBodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jXDatePicker3, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGroup(jPanelBodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelBodyLayout.createSequentialGroup()
                        .addGap(118, 118, 118)
                    ...
                    .addGroup(jPanelBodyLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jScrollPaneBody, javax.swing.GroupLayout.DEFAULT_SIZE, 215, Short.MAX_VALUE)))
                .addGap(18, 18, 18)
                .addComponent(jScrollPaneBody2, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(32, 32, 32))
        );
    ...
    private void btn_enterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_enterActionPerformed
       ...
       while (no_of_products>0){
            ...
            DFPane.add(product2);
            DFPane.add(Box.createRigidArea(new Dimension(Integer.MAX_VALUE, 10)));    
            DFPane.revalidate();            
            no_of_products--;
            prod++;
    ...
    private void btn_select_dc_ecnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_select_dc_ecnActionPerformed
        String txtEcnId = txt_ecn_id.getText();
        ...
        if (txtEcnId.isEmpty()) {
            ...
            ecnYear=Integer.parseInt(txtEcnId.substring(4,6));
            ecnNumber=Integer.parseInt(txtEcnId.substring(7));
            p_year = Pattern.compile("[0-9]|[1-9][0-9]");
            m_year = p_year.matcher(txtEcnId.substring(4,6));
            p_number = Pattern.compile("[0-9]+");
            m_number = p_number.matcher(txtEcnId.substring(7));
            
            if (!"ECN-".equals(txtEcnId.substring(0,4)) || !(m_year.matches()) || !(m_number.matches())){
            JOptionPane.showMessageDialog(null,"Invalid ECN ID Format", "Invalid ECN",JOptionPane.INFORMATION_MESSAGE); 
                ...
                try {
                  ...
                  ResultSet result = stcon.selectData("SELECT p_name FROM product WHERE ecn_year='"+ecnYear+"' AND ecn_number='"+ecnNumber+"' AND d_type='DC'");
                  ...
                  //if (isLogin==0) {
                  //    JOptionPane.showMessageDialog(null,"Incorrect Username and/or Password", "Invalid Login",JOptionPane.INFORMATION_MESSAGE);
                  //}
                 }
    ...
    }//GEN-LAST:event_btn_select_dc_ecnActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ECN_DF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton btn_select_dc_ecn;
    private javax.swing.JButton btn_submit;
    private javax.swing.JPanel jPanel2;
    private javax.swing.JPanel jPanelBody;
    private javax.swing.JScrollPane jScrollPaneBody;
    private javax.swing.JScrollPane jScrollPaneBody2;
